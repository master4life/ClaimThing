...
public class MemberList {
    public void openMenu( Player player, ProtectedRegion region ) {
        ...
        menu.setItem( 4, 6, ItemBuilder.from( Material.PAPER ).setName( "§eGuide:" ).setLore( "", "§7Members can interact with your claim", "§7but can't add or edit flags", "§f§LRIGHT CLICK", "  §5Remove player on the list" ).asGuiItem() );
